...
body.addEventListener('keydown', (e) => {keyDetect = e.key})
...
function App() 
{
  ...
  function countWrongLetters(e, lettersWord) {
    ...
    if (keyDetect !== 'Backspace' &&
        word[inputLength] !== input[inputLength]) {
          wrongLettersCounter++
    }
    if (lettersCounter !== 0)
      writingPrecision = (lettersCounter - wrongLettersCounter) * 100 / lettersCounter
